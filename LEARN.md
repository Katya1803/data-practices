...
### 3.2 Cache-aside Pattern (đang dùng trong project)
...
### 3.3 Cache Eviction — Xóa cache khi dữ liệu thay đổi
...
### 3.4 TTL — Thời gian sống của cache
...
### 3.7 Redis vs PostgreSQL — khi nào dùng gì?
